...
#    ids += [6,7,8,9,5,3,2,4,0]
    ...
    figure = visual_plt.plot_bar(means, names=names, colors=colors, ylabel="Average precision",
                                 title=None, yerr=cis if len(seed_list)>1 else None, ylim=(0,1))
    ...
    figure = visual_plt.plot_lines(ave_lines, x_axes=x_axes, line_names=names, colors=colors, title=title,
                                   xlabel="Tasks", ylabel="Average precision", 
