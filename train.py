...
def train_cl(model, train_datasets, replay_mode="none", dnclen=None, z0=torch.tensor([]), scenario="class",classes_per_task=None,iters=2000,batch_size=32,
    ...
    for task, train_dataset in enumerate(train_datasets, 1):
        ...
        for batch_index in range(1, iters_to_use+1):
            ...
            if list(z0.size())[0]!=0:
                impor=[1/list(z0.size())[0]] * list(z0.size())[0]
            else:
            ...
            #print('xsm task000000:',task)
            if Generative or Current:


                # Get replayed data (i.e., [x_]) -- either current data or use previous generator
                #print('xsm task111111111:',task)
                #print('xsm Generative:',Generative)
                #print('xsm Current:',Current)

                x_ = x if Current else previous_generator.sample(batch_size,dnclen,batch_index,z0,task,len(train_datasets),t_label,impor,pi,model,task)  #xsm 
