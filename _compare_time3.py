...
filelist=glob.glob("/home/sx47/sda1/xsm/Lifelong learning/Lifelong learning_DNC2/*.csv")
for file in filelist:
  os.remove(file)



filelist=glob.glob("/home/sx47/sda1/xsm/Lifelong learning/Lifelong learning_DNC2/plots/*.png")
for file in filelist:
  os.remove(file)


import shutil
shutil.copy2("/home/sx47/sda1/xsm/Lifelong learning/Lifelong learning_DNC2/results/impor.csv", "/home/sx47/sda1/xsm/Lifelong learning/Lifelong learning_DNC2/impor.csv") # complete target filename given
